export class Group {
  ...
  constructor(id: number, name: String, password: string, time_to_start: Date,
              description: string, group_user_uuid: string,
              numOfRdyPeople: number | undefined, numOfAllPeople: number | undefined,
              iPickedTime: boolean | undefined) {
    this.id = id;
    this.name = name;
